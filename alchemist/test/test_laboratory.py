...
def test_full_experiment_normal_usage():
    with open(os.path.join(os.path.dirname(__file__), "fixtures.yml"), 'r') as fixture_file:
    ...
    assert lower == fixture['lower_final'] and upper == fixture['upper_final'] and count == fixture['num_reactions']
...
def test_update_shelves_reaction():
    ...
    assert lab.shelves['lower'] == fixture["lower_answer"] and lab.shelves['upper'] == fixture["upper_answer"]
...
def test_do_a_reaction_random_sampling():
    ...
    assert lab.shelves['lower'] == fixture['lower_final'] and (
        lab.shelves['upper'] == fixture['upper_final_1'] or lab.shelves['upper'] == fixture['upper_final_2'])
